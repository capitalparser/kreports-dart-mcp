...
run_step "policies 2025 KOSPI" \
  .venv/bin/kreports collect-policies --market KOSPI --year 2025 --limit 10000

run_step "policies 2025 KOSDAQ" \
  .venv/bin/kreports collect-policies --market KOSDAQ --year 2025 --limit 10000
