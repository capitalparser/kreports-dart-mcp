...
log "source documents backfill started"
...
run_step "rerun all business-report extractors from source documents" \
  .venv/bin/kreports run-document-extractors --source-type business_report

run_step "rerun audit-report extractors from source documents" \
...
log "source documents backfill finished"
