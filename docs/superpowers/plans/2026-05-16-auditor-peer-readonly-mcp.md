...
Required scope:
- Dataset aggregation and readiness CLI for auditor peer use.
- DART-key-free read-only MCP runtime.
- Cache-first accounting policy lookup.
- Explicit peer group selection tool.
- Auditor-oriented peer comparison using audit fee, audit hours, disclosures, and financial risk metrics.
...
.venv/bin/kreports collect-all --year-from 2024 --year-to 2025
.venv/bin/kreports collect-disclosures --market KOSPI --start-date 20250101 --end-date 20260515
.venv/bin/kreports collect-disclosures --market KOSDAQ --start-date 20250101 --end-date 20260515
.venv/bin/kreports collect-audit-fees --market KOSPI --year-from 2024 --year-to 2025
.venv/bin/kreports collect-audit-fees --market KOSDAQ --year-from 2024 --year-to 2025
...
- KOSPI/KOSDAQ `financial_any_2025` >= 95%.
- KOSPI/KOSDAQ `audit_fee_2025` >= 95%.
